...
single_gene_matrix_regression<-function(targetobj,ngctrlgene=c('NonTargetingControlGuideForHuman'),indmatrix=NULL,high_gene_frac=0.01,selected_genes_list=NULL){
